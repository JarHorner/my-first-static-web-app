...
export const addCustomer = async (
  ...
  const response = await fetch(`https://my-first-node-web-app.azurewebsites.net/customers/`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        // "Authorization": "Bearer your_token" // Uncomment if authorization is needed
...
export const removeCustomer = async (id, firstName) => {
  ...
  const response = await fetch(`https://my-first-node-web-app.azurewebsites.net/customers/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        // "Authorization": "Bearer your_token" // Uncomment if authorization is needed
